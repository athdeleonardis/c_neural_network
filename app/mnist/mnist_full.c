...
#define NN_HIDDEN_LAYER_SIZES { 32 }
...
void mnist_full() {
    ...
    neural_network_t *neural_network = neural_network_init();
...
neural_network_t *neural_network_init() {
    int layer_sizes[NN_HIDDEN_LAYER_COUNT] = NN_HIDDEN_LAYER_SIZES;
