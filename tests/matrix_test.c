...
int int_multiplier(int a, int b) {
    return a*b;
}
...
matrix_t *matrix_from_cmd(const char *name) {
    ...
    matrix_set_algebra(mat, (data_adder_t)int_adder, (data_multiplier_t)int_multiplier, 0);
    matrix_set_data_functions(mat, NULL, (data_printer_t)int_printer);
